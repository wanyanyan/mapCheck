...
<div class="foxgis-data-cards">
  ...
  <div class="card" v-for="u in pageConfig.page_item_num" v-if="((pageConfig.current_page-1)*pageConfig.page_item_num+$index) < dataset.length" track-by="$index">
    ...
    <div class="card-right">
      <a v-link="{ path: '/mapcheck/'+dataset[(pageConfig.current_page-1)*pageConfig.page_item_num+$index].style_id }"><mdl-anchor-button colored v-mdl-ripple-effect>进入</mdl-anchor-button></a>
    </div>
  </div>
